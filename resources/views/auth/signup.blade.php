    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading"> Candidate Register(New Account)</div>
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/signup') }}">
                        ...
                        <div class="form-group{{ $errors->has('email-confirmation') ? ' has-error' : '' }}">
                            <label for="email-confirm" class="col-md-4 control-label">Confirm E-Mail</label>

                            <div class="col-md-6">
                                <input id="email-confirm" type="email" class="form-control" name="email-confirmation">
